...
function displayRecipesGallery(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        picture.setAttribute("src", `./assets/images/${arr[i].image}`);
        ...
        time_text.innerHTML = `${arr[i].time}min`;
        ...
        recipe_name.innerHTML = arr[i].name;
        ...
        recipe_description.innerHTML = arr[i].description;
        ...
        let ingredients = arr[i].ingredients;
